 ...
 */
class FrontendusermanagerControllerUsermanagers extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'usermanager', $prefix = 'FrontendusermanagerModel', $config = array())
	{
